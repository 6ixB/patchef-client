import { EditCommandStep1 } from "@/components/app/sidebar/edit-command-stepper/edit-command-step-1";
import { EditCommandStep2 } from "@/components/app/sidebar/edit-command-stepper/edit-command-step-2";
import { EditCommandStep3 } from "@/components/app/sidebar/edit-command-stepper/edit-command-step-3";
import { EditCommandStep4 } from "@/components/app/sidebar/edit-command-stepper/edit-command-step-4";
import { EditCommandStep5 } from "@/components/app/sidebar/edit-command-stepper/edit-command-step-5";
import { EditCommandStepperStatus } from "@/components/app/sidebar/edit-command-stepper/edit-command-stepper-status";
...
interface EditCommandStepProps {
  step: Step;
  hasPrev: boolean;
  hasNext: boolean;
  prev: () => void;
...
export { type EditCommandStepProps, EditCommandStepper };
