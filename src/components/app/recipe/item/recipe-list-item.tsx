import { RecipeListItemFillParamsButton } from "@/components/app/recipe/item/recipe-list-item-fill-params-button";
import { RecipeListItemRemoveButton } from "@/components/app/recipe/item/recipe-list-item-remove-button";
          ...
          <CardContent className="space-y-2 pb-4">
            <div className="flex flex-wrap items-center gap-2">
              {!command.parameters && (
                ...
                >
                  This command has no main parameters
                </Badge>
              )}
              {!command.options && (
                <Badge
                  ...
                  className="flex items-center gap-x-1"
                >
                  This command has no main options
                </Badge>
              )}
