          ...
          <AnimatePresence mode="popLayout">
            {hoveredIndex === item.id && (
              <motion.div
                ...
                className="absolute -bottom-16 -left-1/2 -translate-x-1/2 flex text-xs  flex-col items-center justify-center rounded-md bg-primary z-50 shadow-xl px-4 py-2"
              >
